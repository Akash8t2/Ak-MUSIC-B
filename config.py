...
OWNER_ID = int(getenv("OWNER_ID", 6918442261))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/friends_chat_groupz")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/friends_chat_groupz")
